package br.unicamp.cotuca.popover.floatingactionbutton;
...
/**
 * Created by Marina on 14/11/2015.
 */
public class FloatingActionButton extends View {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColor = a.getColor(R.styleable.FloatingActionButton_colorFAB, Color.WHITE);
